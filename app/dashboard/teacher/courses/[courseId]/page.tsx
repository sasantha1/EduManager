    ...
    const fetchCourseDetails = async () => {
      try {
        ...
        if (courseResponse.success && courseResponse.data) {
          ...
          const formattedSchedules = realCourse.schedules && realCourse.schedules.length > 0 
          ...
          setCourse({
            ...
            instructor: realCourse.teacher ? realCourse.teacher.name : "Not assigned",
            progress: getProgressForCourse(realCourse.code),
            description: realCourse.description,
            
            // Generate consistent mock data based on the course code
            ...
            // Department info from teacher if available
            department: realCourse.teacher ? realCourse.teacher.department : "Computer Science"
          })
        } else {
          toast({
