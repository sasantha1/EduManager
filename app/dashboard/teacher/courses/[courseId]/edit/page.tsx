...
export default function EditCoursePage() {
      ...
      try {
        ...
        if (!userData || !userData.id) {
          toast({
            ...
            description: "Please log in again to edit this course.",
            variant: "destructive",
          })
          router.push('/login')
          return
        ...
        // Fetch the teacher profile to get teacherId
        const teacherResponse = await api.protected.fetchWithAuth(`/teachers/${userData.id}`)
        ...
        if (!courseResponse.success || !courseResponse.data) {
          throw new Error(courseResponse.message || "Failed to fetch course details")
        }
        
        const course = courseResponse.data
        
        // Initialize schedules array with defaults if none exist
        ...
        setFormData({
          ...
          teacherId: teacherId, // Use formatted teacher ID
          schedules
        })
      } catch (error) {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // Submit the course update request
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-2">
                ...
                <Input
                  ...
                  disabled
                />
                <p className="text-xs text-muted-foreground">This course is assigned to your teacher account</p>
              </div>
            </div>
