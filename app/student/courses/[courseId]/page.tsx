...
export default function CourseDetailPage() {
  ...
  useEffect(() => {
    // Update the fetchCourseDetails function:
                ...
                <CardContent>
                  <div className="space-y-4">
                    {module.content.map((item) => (
                      <div
                        key={item.id}
                        className={`flex items-start justify-between rounded-md border p-3 ${!module.isActive ? "cursor-not-allowed" : "hover:bg-gray-50"
                          }`}
                      >
